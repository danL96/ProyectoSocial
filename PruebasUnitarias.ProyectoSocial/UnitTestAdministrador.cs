...
namespace PruebasUnitarias.ProyectoSocial
{
    ...
    public class UnitTestAdministrador
    {
        ...
        [TestMethod]
        public void TestDesencriptarClave()
        {
            const string encrypted = "2TkLvUMsQ2G5nUaffn4+BORNh79tZWE5";
            const string expected = "thepassword";

            var actual = Utilidades.DesencriptarClave(encrypted);
